...
<!-- Mirrored from demo.epic-webdesign.com/tf-leadpage/v8/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2023 06:08:49 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Loading Bootstrap -->
    <link href="backs/css/bootstrap.min.css" rel="stylesheet">

    <!-- Loading Template CSS -->
    <link href="backs/css/style.css" rel="stylesheet">
    <link href="backs/css/animate.css" rel="stylesheet">
    <link rel="stylesheet" href="backs/css/pe-icon-7-stroke.css">
    <link href="backs/css/style-magnific-popup.css" rel="stylesheet">

    <!-- Awsome Fonts -->
    <link rel="stylesheet" href="backs/css/all.min.css">
		...
		<div class="container">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-12 text-center" style="position: relative;">
	          		...
	          		<h1>Yoga &amp; Pilates Classes In London</h1>

	          		<p class="hero-text">The most affordable yoga classes in town.</p>

                    <a href="#about" class="btn-green scrool">Explore Our Services</a><br>

                    <a href="#about" class="arrow-down scrool"><i class="pe-7s-angle-down-circle"></i></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 padding-top-40">
                    ...
                    <h3>Affordable yoga classes in London.</h3>
                ...
                <div class="col-md-6">
                    ...
                    <img src="images/about1.jpg" class="width-100 top-margins-images box-shadow" alt="pic">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <img src="images/about2.jpg" class="width-100 margin-right-15 box-shadow" alt="pic">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services">
                            ...
                            <img src="images/our-services1.jpg" class="width-100" alt="pic">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services">
                            ...
                            <img src="images/our-services2.jpg" class="width-100" alt="pic">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services">
                            ...
                            <img src="images/our-services3.jpg" class="width-100" alt="pic">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center padding-bottom-20">
                    ...
                    <p class="section-subtitle">The most affordable yoga classes in town.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        ...
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga1.jpg">
                                <img src="images/yoga1.jpg" class="width-100" alt="pic">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga2.jpg">
                                <img src="images/yoga2.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga3.jpg">
                                <img src="images/yoga3.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga4.jpg">
                                <img src="images/yoga4.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga5.jpg">
                                <img src="images/yoga5.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga6.jpg">
                                <img src="images/yoga6.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga7.jpg">
                                <img src="images/yoga7.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/yoga8.jpg">
                                <img src="images/yoga8.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center padding-top-30">
                    ...
                    <p class="follow-instagram">Like what you see? Follow us <a href="#">@leadpage_yoga</a></p>
        ...
        <div class="container-fluid px-0">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6">
                    ...
                    <img src="images/register-image2.jpg" class="width-100" alt="Happy">
                ...
                <div class="col-md-6 margin-top-40">
                    ...
                    <div class="register-form-wrapper wow bounceIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
                        ...
                        <p>Fill the form bellow for a free, no obligation quote.</p>
                        ...
                        <div>
                            ...
                            <!--begin register form -->
                            <form id="register-form" class="register-form register" action="https://demo.epic-webdesign.com/tf-leadpage/v8/php/register.php" method="post">
                                ...
                                <select class="register-input white-input" required="" name="register_ticket">
                                    ...
                                    <option value="Individual">Yoga Classes</option>

                                    <option value="Professional">Pilates Classes</option>
...
<!-- Mirrored from demo.epic-webdesign.com/tf-leadpage/v8/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Aug 2023 06:08:56 GMT -->
</html>
